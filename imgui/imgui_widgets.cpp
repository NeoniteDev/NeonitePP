...
bool ImGui::InputText(const char* label, char* buf, size_t buf_size, ImGuiInputTextFlags flags, ImGuiInputTextCallback callback, void* user_data)
{
    ...
    return InputTextEx(label, NULL, buf, (int)buf_size, ImVec2(250,0), flags, callback, user_data);
}
...
{
    IM_ASSERT(!(flags & ImGuiInputTextFlags_Multiline)); // call InputTextMultiline()
    return InputTextEx(label, hint, buf, (int)buf_size, ImVec2(250, 0), flags, callback, user_data);
}
...
bool    ImGui::BeginTabBarEx(ImGuiTabBar* tab_bar, const ImRect& tab_bar_bb, ImGuiTabBarFlags flags, ImGuiDockNode* dock_node)
{
    ...
    // Draw separator
    const ImU32 col = GetColorU32((flags & ImGuiTabBarFlags_IsFocused) ? ImGuiCol_Border : ImGuiCol_Tab);
...
bool    ImGui::TabItemEx(ImGuiTabBar* tab_bar, const char* label, bool* p_open, ImGuiTabItemFlags flags, ImGuiWindow* docked_window)
{
    ...
    const ImU32 tab_col = GetColorU32((held || hovered) ? ImGuiCol_ButtonActive : tab_contents_visible ? (tab_bar_focused ? ImGuiCol_ButtonHovered : ImGuiCol_TabUnfocusedActive) : (tab_bar_focused ? ImGuiCol_Button : ImGuiCol_TabUnfocused));
