//https://github.com/qoollo/simple-cpp-router
#include "request.h"
#include "response.h"
using namespace Routing;

http::response<http::dynamic_body> handle_request(http::request<http::string_body> req, http::response<http::dynamic_body> res)
{
