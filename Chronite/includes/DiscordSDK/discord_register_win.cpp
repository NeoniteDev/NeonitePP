                      ...
                      DWORD len)
{
	...
	if (subkey && subkey[0])
	{
		if ((ret = RegCreateKeyExW(hkey, subkey, 0, nullptr, 0, KEY_ALL_ACCESS, nullptr,
		                           &hsubkey, nullptr)) !=
			ERROR_SUCCESS)
			return ret;
		htkey = hsubkey;
                              ...
                              const wchar_t* command)
{
	...
	HKEY key;
	auto status =
	RegCreateKeyExW(HKEY_CURRENT_USER, keyName, 0, nullptr, 0, KEY_WRITE,
	                nullptr, &key, nullptr);
	...
	result =
	RegSetKeyValueW(key, nullptr, nullptr, REG_SZ, protocolDescription,
	                len * sizeof(wchar_t));
	if (FAILED(result))
	{
	...
	result = RegSetKeyValueW(
		key, L"DefaultIcon", nullptr, REG_SZ, exeFilePath,
	...
	result = RegSetKeyValueW(
		key, L"shell\\open\\command", nullptr, REG_SZ, openCommand,
		len * sizeof(wchar_t));
	if (FAILED(result))
	{
...
extern "C" DISCORD_EXPORT void Discord_RegisterSteamGame(
